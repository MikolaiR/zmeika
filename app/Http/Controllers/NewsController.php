...
class NewsController extends Controller
{
    public function index()
    {
        ...
        return view('pages.news.index', ['news' => NewSletter::news()->get(), 'title' => $title, 'description' => $description, 'keywords' => $keywords]);
    }
    ...
    public function detail($slug)
    {
        ...
        return view('pages.news.detail', ['new' => $new, 'title' => $title, 'description' => $description, 'keywords' => $keywords]);
    }
}
