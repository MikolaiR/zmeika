...
@section('content')
    <section data-bs-version="5.1" class="form03 cid-ubUb8y0xZ9" id="form03-5" style="margin-top: 15vh; margin-bottom: 20vh">
        <div class="container">
                    ...
                    <div class="col-lg-12 mx-auto mbr-form" data-form-type="formoid">
                        <form action="/message" method="POST" class="mbr-form form-with-styler"
                            ...
                            <input type="hidden" name="email" data-form-email="true"
                                   value="rZ7Sz1mDp+BJmN+Xpsc8cHsJbn4PgvSZKMkbpn4GVrBuAJynnoClFrqcpge9HjOzEEY+lXAWIrI4/K/Nit8Z9/hkdPkuO1+SAl+7QYlyR5t2MgriBa1JQkfAKTj1tVKe">
                            <div class="row">
...
{{--                                </div>--}}
                ...
                <div class="col-12 col-lg-6">
                    <div class="image-wrapper">
                        <img class="w-100" src="{{ asset('images/main/photo-1546992772-3318f1f3a1be.webp') }}" alt="Zmeika.pro">
                    </div>
                </div>
            </div>
        </div>
