                                ...
                                <div class="product-thumb-area">
                                    <div class="product-details-thumbnail">
                                        <div class="product-thumbnail-slider" id="thumb-gallery">
                                            <figure class="pro-thumb-item" data-mfp-src="{{ url('') }}/assets/img/product/product-details-1.png">
                                                <img src="{{ url('') }}/assets/img/product/product-details-1.png" alt="Product Details" />
                                            </figure>
                                            <figure class="pro-thumb-item" data-mfp-src="{{ url('') }}/assets/img/product/product-details-2.png">
                                                <img src="{{ url('') }}/assets/img/product/product-details-2.png" alt="Product Details" />
                                            </figure>
                                            <figure class="pro-thumb-item" data-mfp-src="{{ url('') }}/assets/img/product/product-details-3.png">
                                                <img src="{{ url('') }}/assets/img/product/product-details-3.png" alt="Product Details" />
                                            </figure>
                                            <figure class="pro-thumb-item" data-mfp-src="{{ url('') }}/assets/img/product/product-details-4.png">
                                                <img src="{{ url('') }}/assets/img/product/product-details-4.png" alt="Product Details" />
                                            </figure>
                                            <figure class="pro-thumb-item" data-mfp-src="{{ url('') }}/assets/img/product/product-details-5.png">
                                                <img src="{{ url('') }}/assets/img/product/product-details-5.png" alt="Product Details" />
                                            </figure>
                                        </div>
                                    ...
                                    <div class="product-details-thumbnail-nav">
                                        <figure class="pro-thumb-item">
                                            <img src="{{ url('') }}/assets/img/product/product-1.png" alt="Product Details" />
                                        </figure>
                                        <figure class="pro-thumb-item">
                                            <img src="{{ url('') }}/assets/img/product/product-2.png" alt="Product Details" />
                                        </figure>
                                        <figure class="pro-thumb-item">
                                            <img src="{{ url('') }}/assets/img/product/product-3.png" alt="Product Details" />
                                        </figure>
                                        <figure class="pro-thumb-item">
                                            <img src="{{ url('') }}/assets/img/product/product-4.png" alt="Product Details" />
                                        </figure>
                                        <figure class="pro-thumb-item">
                                            <img src="{{ url('') }}/assets/img/product/product-5.png" alt="Product Details" />
                                        </figure>
                                    </div>
                                </div>
                            </div>
                                                ...
                                                <div class="display-ratings">
                                                    <div class="rating-item">
                                                        <div class="rating-author-pic">
                                                            <img src="{{ url('') }}/assets/img/extra/author-1.jpg" alt="author" />
                                                        </div>
                                                    ...
                                                    <div class="rating-item">
                                                        <div class="rating-author-pic">
                                                            <img src="{{ url('') }}/assets/img/extra/author-2.jpg" alt="author" />
                                                        </div>
