...
(function($) {
    ...
    jQuery(document).ready(function($) {
        ...
        $(".product-carousel").slick({
            ...
            arrows: true,
            adaptiveHeight: true,
            nextArrow: '<button class="slick-next"><i class="ion-chevron-right color-white"></i></button>',
            prevArrow: '<button class="slick-prev"><i class="ion-chevron-left color-white" ></i></button>',
            responsive: [{
                    breakpoint: 480,
                    settings: {
                        slidesToShow: 1,
